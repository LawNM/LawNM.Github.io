const apiURL2 = "https://api.openweathermap.org/data/2.5/weather?id=5585010&units=imperial&appid=7fb334586cf67f2a93d9a12e96f99ad5"
fetch (apiURL2)
    ...
    const castURL2 = "https://api.openweathermap.org/data/2.5/forecast?id=5585010&units=imperial&appid=7fb334586cf67f2a93d9a12e96f99ad5"
fetch (castURL2)
    .then((response) => response.json())
    .then((newObject) => {
