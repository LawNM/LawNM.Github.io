const apiURL3 = "https://api.openweathermap.org/data/2.5/weather?id=5607916&units=imperial&appid=7fb334586cf67f2a93d9a12e96f99ad5"
fetch (apiURL3)
    ...
    const castURL3 = "https://api.openweathermap.org/data/2.5/forecast?id=5604473&units=imperial&appid=7fb334586cf67f2a93d9a12e96f99ad5"
fetch (castURL3)
    .then((response) => response.json())
    .then((newObject) => {
